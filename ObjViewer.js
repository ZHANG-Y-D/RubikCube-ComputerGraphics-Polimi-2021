...
window.onload = function main(){
	...
	// 获取名称为"a_TexCoord"的shader attribute变量的位置
    var a_TexCoord = gl.getAttribLocation(program, "a_TexCoord");
	if(a_TexCoord < 0){ // getAttribLocation获取失败则返回-1
		alert("获取attribute变量a_TexCoord失败！"); 
		return;
	}
...
function render() {
	...
	if(!obj00.isAllReady(gl)||!obj00B.isAllReady(gl)||!obj00M.isAllReady(gl)) {
