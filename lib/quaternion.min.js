...
(function (w) {
    ...
    function q(a, b, c, e, d) {
        if (void 0 !== d) a.w = b, a.x = c, a.y = e, a.z = d; else {
            ...
            if ("string" === typeof b && void 0 === e) {
                ...
                for (d = a.w = a.x = a.y = a.z = 0; d < b.length; d++) {
                    var g = b[d], h = b[d + 1];
                    if (" " !== g && "\t" !== g && "\n" !== g) if ("+" === g) f++; else if ("-" === g) c++; else {
                        if (0 === f + c) throw Error("Parse error" + g);
                        f = e[g];
                        if (void 0 !== f) " " === h || isNaN(h) ? g = "1" : (g = h, d++); else {
    ...
    h.prototype = {
        w: 1, x: 0, y: 0, z: 0, add: function (a,
                                               b, c, e) {
            q(k, a, b, c, e);
            ...
            var a = this.w, b = this.x, c = this.y, e = this.z;
            return Math.sqrt(a * a + b * b + c * c + e * e)
        }, normSq: function () {
            var a = this.w, b = this.x, c = this.y, e = this.z;
            return a * a + b * b + c * c + e * e
        }, normalize: function () {
            var a = this.w, b = this.x, c = this.y, e = this.z, d = Math.sqrt(a * a + b * b + c * c + e * e);
            if (d <
            ...
            var a = this.w, b = this.x, c = this.y, e = this.z, d = a * a + b * b + c * c + e * e;
            ...
            c = this.y;
            e = this.z;
            var d = k.w, f = k.x, g = k.y, m = k.z, n = d * d + f * f + g * g + m * m;
            ...
            var a = this.x, b = this.y, c = this.z, e = Math.sqrt(a * a + b * b + c * c), d = Math.exp(this.w),
                f = d / e * Math.sin(e);
            ...
            var b = this.w, c = this.x,
                e = this.y, d = this.z, f = b * b + c * c + e * e + d * d, g = 0 === f ? 0 : 2 / f;
            f = g * b * c;
            var h = g * b * e;
            b = g * b * d;
            var k = g * c * c, l = g * c * e;
            ...
            var b = this.w, c = this.x, e = this.y, d = this.z, f = b * b + c * c + e * e + d * d,
                g = 0 === f ? 0 : 2 / f;
            f = g * b * c;
            var h = g * b * e;
            b = g * b * d;
            ...
            var b = this.w, c = this.x, e = this.y, d = this.z, f = a[0], g = a[1], h = a[2];
            a = -c * f - e * g - d * h;
            var k = b * f + e * h - d * g, l = b * g + d * f - c * h;
            f = b * h + c * g - e * f;
            return [k * b - a * c - l * d + f * e, l * b - a * e - f * c + k * d, f * b - a * d - k * e + l * c]
        }, slerp: function (a, b, c, e) {
            q(k, a, b, c, e);
            var d = this.w, f = this.x, g = this.y, m = this.z, n = k.w, l = k.x, p = k.y, r = k.z,
                t = d * n + f * l + g * p + m * r;
            ...
            var u = Math.acos(t), v = Math.sin(u);
            return function (a) {
                var b = u * a;
                a = Math.sin(b);
                b = Math.cos(b) - t * a / v;
    ...
    "function" === typeof define && define.amd ? define([], function () {
        return h
    }) : "object" === typeof exports ? (Object.defineProperty(exports, "__esModule", {value: !0}), h["default"] = h, h.Quaternion = h, module.exports = h) : w.Quaternion = h
})(this);